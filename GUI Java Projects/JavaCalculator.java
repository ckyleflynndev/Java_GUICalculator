 ...
 */
import javax.swing.*;
public class JavaCalculator extends javax.swing.JPanel {
    double firstNumber;
    double secondNumber;
    double result;
    double thirdNumber;
    ...
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
        ...
        thirdNumber = Double.parseDouble(jTextField1.getText());
        jTextField1.setText(" ");
    ...
    public static void main(String[] args){
        SwingUtilities.invokeLater(new Runnable ()
        {
            public void run()
            {
                JavaCalculator gui = new JavaCalculator();
                JFrame MyFrame=new JFrame("Calculator2017");
                MyFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
                MyFrame.getContentPane().add(gui);
                MyFrame.pack();
